...
export async function getLLMUsageSummary(userId: string): Promise<any> {
    const res = await fetch(
        `http://localhost:8000/api/v1/users/${userId}/llm-usage-summary`,
        {
            credentials: "include",
            headers: { Authorization: `Bearer ${localStorage.access_token}` },
        },
...
export async function updateClientSpecifics(
    userId: string,
    data: any,
): Promise<any> {
    const res = await fetch(
        `http://localhost:8000/api/v1/users/${userId}/client-specifics`,
        {
            method: "PATCH",
            headers: {
...
export async function getPostings(): Promise<any> {
    const res = await fetch(`http://localhost:8000/api/v1/utils/posts`, {
        credentials: "include",
        headers: { Authorization: `Bearer ${localStorage.access_token}` },
    });
...
export async function updatePosting(id: string, data: any): Promise<any> {
    const res = await fetch(`http://localhost:8000/api/v1/utils/posts/${id}`, {
        method: "PATCH",
        headers: {
            "Content-Type": "application/json",
            Authorization: `Bearer ${localStorage.access_token}`,
...
export async function generatePostIdeas(
    ...
    const res = await fetch(
        `http://localhost:8000/api/v1/llm/generate-post-ideas`,
        {
            method: "POST",
            headers: {
                "Content-Type": "application/json",
...
export async function generatePostContent(
    ...
    const res = await fetch(
        `http://localhost:8000/api/v1/llm/generate-post-content`,
        {
            method: "POST",
            headers: {
                "Content-Type": "application/json",
...
export async function generateHashtags(
    ...
    const res = await fetch(
        `http://localhost:8000/api/v1/llm/generate-hashtags`,
        {
            method: "POST",
            headers: {
                "Content-Type": "application/json",
