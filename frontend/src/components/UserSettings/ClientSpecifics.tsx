            ...
            <Box key={user.id} p={4} mb={8} borderWidth={1} borderRadius="md">
                ...
                <Box mt={3} p={3} bg="gray.50" borderRadius="md">
                  ...
                  <HStack spacing={4} wrap="wrap">
                    ...
                    <Badge colorScheme="purple">
                      Cost: {formatCost(usage.total_cost_usd)}
                    </Badge>
                  </HStack>
                  {Object.keys(usage.requests_by_provider).length > 0 && (
                    <Text fontSize="sm" mt={2} color="gray.600">
                      Providers:{' '}
                      {Object.entries(usage.requests_by_provider)
              ...
              <VStack gap={3} mt={2}>
                ...
                <Field label="Business Description">
                  <Textarea
                    value={
                      form[user.id]?.business_description ??
                ...
                <Field label="Client Avatars">
                  <Textarea
                    ...
                    onChange={e =>
                      handleChange(user.id, 'client_avatars', e.target.value)
                    }
                  />
                </Field>
                <Button
