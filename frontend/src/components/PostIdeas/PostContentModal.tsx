...
import { generatePostContent, createPosting, generateHashtags, generateImage } from '../../client/core/request';
...
export default function PostContentModal({ isOpen, onClose, postIdea, onPostCreated }: PostContentModalProps) {
  ...
  const handleSavePost = async () => {
    ...
    try {
      ...
      try {
        ...
        console.warn("Failed to generate hashtags, using empty hashtags");
      }
        ...
        <DialogBody>
          <VStack gap={4} alignItems="stretch">
            <Box p={3} bg="blue.50" borderRadius="md">
              <Text fontWeight="semibold" mb={2}>Selected Post Idea:</Text>
            ...
            {!generatedContent ? (
              ...
              <VStack gap={4} alignItems="stretch">
                ...
                <Field label="Image Description">
                  <VStack gap={2} alignItems="stretch">
                    <Textarea
                      value={generatedContent.image_description}
                      readOnly
                      rows={2}
                    />
                    <Button
